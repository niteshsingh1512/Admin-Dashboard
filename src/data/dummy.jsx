...
export const EditorData = () => (
  <div>
    <h3>
      Nitesh Singh Email: [niteshsingh1512ask@gmail.com ] | LinkedIn:
      [https://www.linkedin.com/in/niteshsingh15/] | GitHub: [niteshsingh1512]
      <br></br>
      I am a skilled web developer with expertise in React.js, HTML, CSS, and
      JavaScript, demonstrated through projects like Le-Chalo (global real
      estate booking platform), NitTube (YouTube replica), and Newsite (dynamic
      news platform). My front-end development experience is complemented by
      knowledge of data structures, algorithms, problem-solving, and leadership
      skills gained from managing teams in college clubs like Spiritual Tech and
      PR Cell. I also have a strong background in UI/UX design, creating
      posters, banners, and websites using Figma, Canva, and Adobe Creative
      Suite.
      <br />I am eager to apply my technical, design, and leadership skills to
      drive innovative web solutions as part of your team.
    </h3>
  </div>
);
